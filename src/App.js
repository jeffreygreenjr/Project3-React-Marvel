...
function App() {
  ...
  return (
    <div className="App">
      ...
      <h4>{Comic.data.results[0].title}</h4>
      <img src={`${Comic.data.results[0].thumbnail.path}.${Comic.data.results[0].thumbnail.extension}`} alt={Comic.data.results[0].title} />
      <p>{`Price: $  ${Comic.data.results[0].prices[0].price}`}</p>
      <h6>Writers:</h6>
      <p>{`${Comic.data.results[0].creators.items[0].name}, ${Comic.data.results[0].creators.items[1].name}`}</p>
      <Footer />
    </div>
  );
}
